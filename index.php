...
<head>
    ...
    ?>
        ...
        <section class="design-area again-design theard">
            <div class="container">
                <div class="row">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 text-center">
                            <div class="pro-text">
                                <h3>The Our Best Products</h3>
                                <img alt="" src="img/icon-img/underline-style-1.png">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                            ...
                            <div class="free-shopping-area">
                                <a href="#">
                                    <div class="tb-service">
                                        ...
                                        <h5 class="tb-title">FREE SHIPPING</h5>
                                        <div class="tb-content">
                            ...
                            <div class="free-shopping-area">
                                <a href="#">
                                    <div class="tb-service">
                                        ...
                                        <h5 class="tb-title">100% MONEY BACK</h5>
                                        <div class="tb-content">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, news do eiusmod tempor incididunt ut labore et dolore.</p>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-4  text-center">
                            <div class="free-shopping-area free-res">
                                <a href="#">
                                    <div class="tb-service">
                                        <div class="tb-icon">
                                            <i class="fa fa-comments"></i>
                                        </div>
                                        <h5 class="tb-title">ONLINE SUPPORT</h5>
                                        <div class="tb-content">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, news do eiusmod tempor incididunt ut labore et dolore.</p>
                                        </div>
                                    </div>
...
<!-- Mirrored from htmldemo.net/noraure/noraure/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Oct 2022 16:44:18 GMT -->
</html>
